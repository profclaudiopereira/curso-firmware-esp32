...
const char* ssid = "Claudio"; /* coloque aqui o nome da rede wi-fi que o ESP32 deve se conectar */
const char* password = "15120813"; /* coloque aqui a senha da rede wi-fi que o ESP32 deve se conectar */
